...
#   LOADER => $LOADER_SIZE-byte string containing the /pintos/userprog/build/loader.binary
#   ARGS => ['arg 1', 'arg 2', ...]
sub assemble_disk {
    my (%args) = @_;
...
sub read_loader {
    my ($name) = @_;
    ###--- Change the string in quotes below to your location of /pintos/userprog/build/loader.bin---### 
